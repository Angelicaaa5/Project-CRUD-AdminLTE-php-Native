      ...
      <div class="box box-primary">
        <div class="box-header">
          <a href="index.php?page=data_multibarang" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
           <a href="pages/report.php"  target="_blank" class="btn btn-warning" role="button" title="Tambah Data"><i class="glyphicon glyphicon-print"></i> Print</a>  
        </div>
            <div class="box-body table-responsive">
              <table id="mahasiswa" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
              <a href="index.php?page=data_detail&id=<?= $row['id']; ?>" class="btn btn-success" role="button" title="Detail"><i class="glyphicon glyphicon-edit"></i></a>
              ...
              <a href="pages/multibarang/hapus_barang_multi.php?id=<?= $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" role="button" title="Hapus Data"><i class="glyphicon glyphicon-trash"></i></a>
                  </td>
                </tr>
